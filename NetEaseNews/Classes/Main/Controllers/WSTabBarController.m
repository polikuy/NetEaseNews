...
//    WSTabBarItem *item2 = [WSTabBarItem tabBarItemWithTitle:@"阅读" itemImage:[UIImage imageNamed:@"tabbar_icon_reader_normal"] selectedImage:[UIImage imageNamed:@"tabbar_icon_reader_highlight"]];
    ...
    WSTabBarItem *item5 = [WSTabBarItem tabBarItemWithTitle:@"天气" itemImage:[UIImage imageNamed:@"tabbar_icon_me_normal"] selectedImage:[UIImage imageNamed:@"tabbar_icon_me_highlight"]];
    
    WSTabBar *tabBar = [WSTabBar tabBarWithItems:@[item1, item3,item4, item5] itemClick:^(NSInteger index) {
